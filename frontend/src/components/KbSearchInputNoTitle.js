...
const KbSearchInputNoTitle = ({ itemProp, codeWidthProp, nameWidthProp, heightProp, inputDatasProp, codeProp, nameProp }) => {
  ...
  const inputSearch = () => {
    const datas = inputDatasProp.filter(data => data[nameProp].includes(inputSearchName));
          ...
          >
            ...
            >
              ...
              >
                ...
                />
                <Kbbutton textProp={""} iconProp={"검색"} stateProp={true} onClick={() => inputSearch()} />
              </div>  
            </div>
            <div>
              <div 
              ...
              {filterDatas.map((inputData, index) => (
                <div  key={index} 
                      ...
                      onDoubleClick={() => {selectedInputData(inputData[codeProp], inputData[nameProp])}} 
                      onKeyDown={(e) => {selectedListEnter(e, inputData[codeProp], inputData[nameProp])}}
            ...
            >
              <Kbbutton textProp={""} iconProp={"닫기"} stateProp={true} onClick={() => togglePopup()} />
            </div>
          </div>
        </div>
      )}
...
export default KbSearchInputNoTitle;
